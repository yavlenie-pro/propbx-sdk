...
export const WS_EVENTS = {
    ...
    CALL_KEEPALIVE: 'callKeepalive',
    FORWARD_STARTED: 'forward-started',
    FORWARDED_CALL_ANSWERED: 'forwardedCallAnswered',
    FORWARDED_CALL_FAILED: 'forwardedCallFailed',
    FORWARDED_CALL_NOT_ANSWERED: 'forwardedCallNotAnswered',
    FORWARDED_CALL_FINISHED: 'forwardedCallFinished',
